...
namespace Unity.AutoLOD.Utilities
{
	...
	public static class ObjectUtils
	{
		...
		/// expose internal SerializedProperty.objectReferenceTypeString to remove this hack
		/// </summary>
		...
		/// expose internal SerialzedProperty.ValidateObjectReferenceValue to remove his hack
		/// </summary>
